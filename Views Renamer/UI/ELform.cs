...
namespace Views_Renamer.UI
{
    public partial class ELform : Form
    {
        ...
        public ELform()
        {
            ...
            threed.Items.Clear();
            RvtUtils.ELCollectRestViews(ExCmd.doc);
            _viewsByCategory = Data.ELViewCategories;
        ...
        private void cattegories_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (selected)
            {
                ...
                case "03_Power":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "04_Equipment Power":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "05_Cable Routing":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "06_TEL-DATA":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                ...
                case "11_Low Current":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "12_NUrse Calling":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "13_BMS":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "14_Panel Schedules":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "15_General Details":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "16_Life Safety":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
        ...
        private void select_Click(object sender, EventArgs e)
        {
            ...
            ExCmd.exevt.request = Request.ELCollector;
        ...
        private void renamer_Click(object sender, EventArgs e)
        {
            ...
            ExCmd.exevt.request = Request.ELrenamer;
            ExCmd.exevthan.Raise();
        }
    }
}
