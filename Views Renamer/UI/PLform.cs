...
namespace Views_Renamer.UI
{
    public partial class PLform : Form
    {
        ...
        public PLform()
        {
            ...
            _viewsByCategory = Data.PLViewCategories;
        ...
        private void cattegories_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (selected)
            {
                ...
                case "02_Drainage":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "03_Water Supply":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "04_Irrigation":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
                case "05_Rainwater Drain":
                    RvtUtils.Switcher(selected, elevations, sections, threed);
                    break;
            }
        }
        ...
        private void renamer_Click(object sender, EventArgs e)
        {
            ...
            ExCmd.exevt.request = Request.PLrenamer;
        ...
        private void select_Click(object sender, EventArgs e)
        {
            ...
            ExCmd.exevt.request = Request.PLCollector;
            ExCmd.exevthan.Raise();
        }
